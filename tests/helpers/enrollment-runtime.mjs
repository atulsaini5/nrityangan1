...
export async function createEnrollmentRuntime(){
 ...
 for(const file of ['20260925021422_create_student_management.sql','20260925025212_add_student_enrollment_consent.sql'])await db.exec(await fs.readFile('supabase/migrations/'+file,'utf8'));
 ...
 const enrollment=createEnrollmentHandler({client:()=>client,allowedOrigins:['http://127.0.0.1:4173']});
